...
// Must stay byte-identical to esp32-incubator-platformio/src/SensorReading.h
// since this struct is decoded straight out of the decrypted LoRa payload.
// Scaling rules (applied by the sender, reversed here):
